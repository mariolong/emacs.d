...
#+BABEL: :cache yes
#+OPTIONS: ^:nil
#+DATE: 2018-06-15 21:56:46 UTC+08:00
#+UID:mario-long-epub-uid-for-kindle-emacs-init.org
...
Ref: [[https://github.com/ofosos/ox-epub][GitHub - ofosos/ox-epub: Org mode epub export]]
...
=======
    ...
    (let* ((uri "dbi:mysql:stock:localhost")
      ...
      (edbi:dbview-open conn))
    (e2wm:dp-edbi))
>>>>>>> a3d88402ba40a2206c162fb2afebae69ccb77a93
...
=======
  (bind-key "C-c sc" 'edbi-close-stock-mysql)
>>>>>>> a3d88402ba40a2206c162fb2afebae69ccb77a93
#+END_SRC

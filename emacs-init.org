...
#+BEGIN_SRC emacs-lisp
  ...
  (defun tangle-mario-init ()
    (when (equal (buffer-file-name) emacs-init-org-file)
      (tangle-emacs-init-org)))

  (add-hook 'kill-emacs-hook 'tangle-emacs-init-org)
  ;; (add-hook 'after-save-hook 'tangle-mario-init)
#+END_SRC
...
** TODO [#B] Flyspell
ref: https://github.com/syl20bnr/spacemacs/blob/master/layers/spell-checking/packages.el
...
*** TODO [#B] auto-dictionary
ref: https://github.com/nschum/auto-dictionary-mode

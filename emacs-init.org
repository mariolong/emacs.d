...
#+BEGIN_SRC emacs-lisp
  ...
  (defun org-kindle-export-to-html ()
    ...
    (let* ((fname (buffer-file-name))
           (fn-html (expand-file-name (concat fname ".html") temporary-file-directory))
           (fn-epub (expand-file-name (concat fname ".epub") temporary-file-directory))
           (fn-mobi (expand-file-name (concat fname ".mobi") temporary-file-directory)))
      (save-excursion
